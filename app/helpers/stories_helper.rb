...
def story_1_header
    ...
    content_tag(:p, "那年，我们看多了生离死别，那年，我们一起见证了生命的奇迹，那年，我们一起经历了生死的考验，那年，我们十三四岁。那是2008年5月12日四川汶川里氏8.0级地震。那已经是五年前的事了。但是无情的灾难总是抵不过温情，那是一股强大的力量，那是一支大爱的队伍，那就是我们最敬爱的志愿者。是啊，在这五年里，每年都有志愿者来震中映秀做义教服务。有长期的，也有假期过来的。他们的到来、他们的作为，使这里孩子们感到了无比的温暖、无限的力量。在这五年里，人们知道了一种新的教育方式——义教，有一种温情是——我们在一起。")
		end
end
def story_1_hero
