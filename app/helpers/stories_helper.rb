...
def story_2_body
    ...
    content_tag(:p,"我看着沿路的山路，巍峨的大山几乎快遮住了天，崎岖的山路都快阻断了外面的世界。我想再高的山也挡不住我们的热情，再弯的路也隔不开我们的爱。
                    我真期望很快看到录象里（") + content_tag(:a, :href => "http://v.youku.com/v_show/id_XMTkzOTYwNDA4.html ")+ content_tag(:span, "）那群可爱的孩子们，他们过得好吗？")+
